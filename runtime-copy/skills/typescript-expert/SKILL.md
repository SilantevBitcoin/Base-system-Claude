...
- `references/tsconfig-strict.json` — production-ready strict tsconfig (all strict flags + ESM + project structure)
- `references/utility-types.ts` — copy-paste utility type library (Brand, Result, Option, and more)
- Full type-system reference (utility/conditional/mapped/guards/branded + advanced worked patterns + module augmentation) → skill `typescript-advanced-types`
