...
description: >
  NestJS architecture patterns for modular TypeScript backends — modules,
  controllers, providers, DTO validation with class-validator, guards,
  interceptors, exception filters, typed config, and testing. Use when building
  NestJS APIs/services, structuring modules, or adding validation/guards/filters.
---
