---
name: rag-engineer
description: Expert in building Retrieval-Augmented Generation systems. Masters embedding models, vector databases, chunking strategies, and retrieval optimization for LLM applications. Use when building RAG, vector/semantic search, embeddings, document retrieval, knowledge bases, or chunking strategy.
license: Apache-2.0 (vibeship-spawner-skills)
---
