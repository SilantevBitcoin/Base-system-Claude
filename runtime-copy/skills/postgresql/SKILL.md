---
name: postgresql
description: "Design a PostgreSQL-specific schema. Covers data types, keys, constraints, indexing, partitioning, RLS, and safe schema evolution. Use when modeling tables for PostgreSQL."
---
...
- Selecting data types and constraints that enforce invariants
...
5. Review migration impact and apply changes safely (backups + staging first; no destructive DDL on prod without a rollback plan).
